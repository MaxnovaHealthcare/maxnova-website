...
export default function Nav() {
  ...
  return (
    <main className="fixed top-0 z-50 flex h-fit w-screen items-center justify-center">
      <nav className="bg-seco z-[4] mt-2 flex h-fit w-11/12 items-center justify-between gap-6 rounded-full py-2 max-md:mt-2 max-md:w-[95%] max-md:flex-wrap max-md:px-6 lg:px-12">
        <Link
          href="/"
          className="flex h-fit w-1/4 items-center justify-start gap-2 font-humane font-semibold max-md:w-1/3"
        >
        ...
        <div
          className={`flex w-3/4 items-center justify-between max-md:w-full max-md:flex-col max-md:gap-8 max-md:${classname}`}
        >
          <div className="flex w-full items-end justify-around gap-4 text-min font-medium max-md:w-full max-md:flex-col max-md:justify-between max-md:gap-8 max-md:text-right max-md:text-subhead">
            <span>
